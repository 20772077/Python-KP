...
print('Тип закрепления панели:')
print('1: Шарнирный')
print('2: Многопролётный')
print('3: Однопролётный')
print('4: Частичный')
print('5: Свободный')
Type = float(input())
print('Толщина, mm: ') 
...
# Сделать в начале работы возможность выбора типа закрепления
# Шарнирный Н, Многопролётный 1.2Н, Однопролётный 1.5Н, Частичный 0.8Н, Свободный 2Н 
l0 = H
# Что-то сделать красивее
